...
export const useContactForm = (): UseContactFormReturn => {
    ...
    const validateFieldAndMarkTouched = useCallback((field: keyof ContactFormData, value: string) => {
    ...
    const handleSubmit = useCallback(async (
        ...
        setTouchedFields(new Set(Object.keys(formData) as Array<keyof ContactFormData>));
